...
exports.KickChatService = void 0;
const ws_1 = __importDefault(require("ws"));
const events_1 = require("events");
const SevenTVService_1 = require("./SevenTVService");
class KickChatService extends events_1.EventEmitter {
    constructor() {
        super();
        this.KICK_API_BASE = 'https://kick.com/api/v2';
        this.PUSHER_APP_KEY = '32cbd69e4b950bf97679';
        this.PUSHER_CLUSTER = 'us2';
        this.ws = null;
        this.currentChannel = null;
        this.isConnected = false;
        this.sevenTVService = new SevenTVService_1.SevenTVService();
    }
    onMessage(callback) {
        this.on('message', callback);
    }
    onChannelConnected(callback) {
    ...
    async connectToPusherWebSocket(channelName) {
    ...
    async transformKickMessage(kickMessage) {
        const cosmetics = await this.sevenTVService.getUserCosmetics(kickMessage.sender.username);
        const user = {
...
exports.KickChatService = KickChatService;
//# sourceMappingURL=KickChatService.js.map